...
// CRUD for chess journey posts.
//
//  GET    /api/posts       → Public:        all published posts (newest first)
//  GET    /api/posts/:id   → Public:        single post by ID
//  POST   /api/posts       → Member/Admin:  create post (admin can attach image)
//  PUT    /api/posts/:id   → Owner or Admin: edit post
//  DELETE /api/posts/:id   → Owner or Admin: delete post
